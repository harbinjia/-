...
from sklearn.feature_extraction.text import TfidfTransformer  # TF-UDF响亮转换类
...
def segText(inputPath, resultPath):
    ...
    for eachDir in fatherLists:   # 遍历主目录中各个文件夹
        eachPath = inputPath + eachDir + "/"  # 保存主目录中每个文件目录，便于遍历二级列表
...
def bunchSave(inputFile, outputFile):
    ...
    with open(outputFile, 'wb') as file_obj:  # 持久化必须用二进制访问模式打开
        ...
        # obj: 想要序列化的obj对象
        # file: 文件名称
        # protocol: 序列化使用的协议. 若省略该项,则默认为0.若为负值或HIGHEST_PROTOCOL,则使用最高的协议版本
...
def getTFDFMat(inputPath, stopWordList, outputPath):  # 求得TF-IDF向量
...
def bayesAlgorithm(trainPath, testPath):
    ...
    # print(shape(trainSet.tdm))  # 输出单词矩阵
...
# 分词, 第一个就是分词输入,第二个参数结果保存的路径
segText("/home/ho/show/shuju/", "/home/ho/show/segResult1/")
bunchSave("/home/ho/show/segResult1/", "/home/ho/show/train_set1.dat")  # 输入分词,输出分词向量
stopWordList = getStopWord("/home/ho/show/stopwords.txt")  # 获取停用词
getTFDFMat("/home/ho/show/train_set1.dat", stopWordList, "/home/ho/show/tfidfspace1.dat")  # 输入词向量,输出特征空间

# 训练集
segText("/home/ho/show/shuju1/", "/home/ho/show/test_segResult1/")  # 分词
bunchSave("/home/ho/show/test_segResult1/", "/home/ho/show/test_set1.dat")
getTestSpace("/home/ho/show/test_set1.dat", "/home/ho/show/tfidfspace1.dat", stopWordList, "/home/ho/show/testspace1.dat")
bayesAlgorithm("/home/ho/show/tfidfspace1.dat", "/home/ho/show/testspace1.dat")
